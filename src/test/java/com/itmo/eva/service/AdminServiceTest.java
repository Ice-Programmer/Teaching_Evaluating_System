...
class AdminServiceTest {
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "22320328@hdu.edu.cn";
...
//        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "帅哥", "UTF-8"));
        message.addRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "帅哥", "UTF-8"));
        ...
        message.setSentDate(nowTime.getTime());
